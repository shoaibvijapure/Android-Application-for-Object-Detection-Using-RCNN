...
public class MainActivity extends Activity implements CNNListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btweb = (Button) findViewById(R.id.btnSelect12);
        ...
        btweb.setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
               // String escapedQuery = URLEncoder.encode(tvLabel.getText().toString(), "UTF-8");
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.google.com#q="+tvLabel.getText()));
